...
#define object_id_buffer shadow_atlas
...
#ifdef USE_MULTIVIEW
layout(set = 1, binding = 38) uniform texture2DArray object_id_buffer;
#else
...
#ifdef USE_MULTIVIEW
layout(set = 1, binding = 40) uniform texture2DArray outlines_buffer;
#else
layout(set = 1, binding = 40) uniform texture2D outlines_buffer;
#endif
